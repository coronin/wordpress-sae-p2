...
function wp_install_defaults( $user_id ) {
	...
	$first_title = @file_get_contents('http://api.gimhoy.com/WordPress_on_SAE/?a=first-post-title&v=4.0&p=SAE');
    if(!$first_title){$first_title = __('Hello world!');}
    $first_post = @file_get_contents('http://api.gimhoy.com/WordPress_on_SAE/?a=first-post-content&v=4.0&p=SAE');
